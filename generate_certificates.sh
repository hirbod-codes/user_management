...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_mongodb_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_mongodb --san user_management_mongodb"
...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_configServer2_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_configServer2 --san user_management_configServer2"
...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_configServer3_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_configServer3 --san user_management_configServer3"
...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_shardServer1_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_shardServer1 --san user_management_shardServer1"
...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_shardServer2_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_shardServer2 --san user_management_shardServer2"
...
bash -c "./generate_certificate.sh --dir $projectRootDirectory/security/user_management_shardServer3_member --caCrt $projectRootDirectory/security/ca/ca.crt --caKey $projectRootDirectory/security/ca/ca.key --configFile client.cnf --extensions req_ext --ou mongodb --cn user_management_shardServer3 --san user_management_shardServer3"
