...
mongod --shardsvr --replSet "$replSet/$member0:$dbPort,$member1:$dbPort,$member2:$dbPort" --bind_ip "0.0.0.0" --port $dbPort --dbpath /data/db --tlsMode requireTLS --clusterAuthMode x509 --tlsCertificateKeyFile /security/app.pem --tlsCAFile /security/ca.pem --tlsClusterFile /security/member.pem --tlsClusterCAFile /security/ca.pem &
